...
export default function About() {
  ...
  const faqs = [
    {
      question: "How does Cyber Sentinel detect malware?",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800">
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-purple-500/15 to-violet-500/15 rounded-lg">
          ...
          <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800">
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-fuchsia-500/15 to-pink-500/15 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800 hover:border-purple-500/30 transition-all">
              ...
              <div className="px-6 pb-6">
                ...
                <Button variant="outline" className="w-full border-slate-700 hover:border-purple-500/50">
                  Get Started
                </Button>
              </div>
            </Card>
            ...
            {/* Pro Plan */}
            <Card className="bg-gradient-to-br from-purple-500/10 to-fuchsia-500/10 backdrop-blur-sm border-purple-500/50 hover:border-purple-500 transition-all relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white text-xs font-semibold px-3 py-1 rounded-full">
                  MOST POPULAR
                </span>
              </div>
              <CardHeader className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">$29</span>
                  <span className="text-slate-400">/month</span>
                </div>
              ...
              <div className="px-6 pb-6">
                ...
                <Button className="w-full bg-gradient-to-r from-purple-500 to-fuchsia-500 hover:from-purple-400 hover:to-fuchsia-400">
                  Start Pro Trial
                </Button>
              </div>
            </Card>
            ...
            <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800 hover:border-fuchsia-500/30 transition-all">
              ...
              <div className="px-6 pb-6">
                ...
                <Button variant="outline" className="w-full border-slate-700 hover:border-fuchsia-500/50">
                  Contact Sales
                </Button>
              </div>
            </Card>
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-400 text-center mb-12">
            See what security professionals are saying about Cyber Sentinel
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800">
              <CardHeader>
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500/20 to-fuchsia-500/20 flex items-center justify-center">
            ...
            <Card className="bg-slate-900/50 backdrop-blur-sm border-slate-800">
              <CardHeader>
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-fuchsia-500/20 to-pink-500/20 flex items-center justify-center">
                ...
                <CardDescription className="text-slate-400">
                  "Cyber Sentinel caught vulnerabilities that other tools missed. The API integration was seamless and the results are incredibly detailed."
                </CardDescription>
              </CardHeader>
            </Card>
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-400 text-center mb-12">
            Everything you need to know about Cyber Sentinel
          </p>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <span className="text-purple-400 text-xl">{openFaq === index ? '−' : '+'}</span>
                </button>
                {openFaq === index && (
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-br from-purple-500/10 to-fuchsia-500/10 border border-purple-500/20 rounded-xl p-8 text-center">
          ...
          <Button
            variant="outline"
            className="border-purple-500/50 hover:border-purple-400 hover:bg-purple-500/10 text-purple-300 hover:text-purple-200"
            asChild
          >
